...
featured_image: 'https://picsum.photos/seed/claude-code-jira-branch-commit-complete-flow/1600/900'
tags: [claude-code, jira, git, ai-agent, workflow]
---

![Claude Code Jira 브랜치 커밋 완료 흐름](https://picsum.photos/seed/claude-code-jira-branch-commit-complete-flow/1600/900)
