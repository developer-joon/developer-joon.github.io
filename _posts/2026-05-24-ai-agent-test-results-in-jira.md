...
featured_image: 'https://picsum.photos/seed/ai-agent-test-results-in-jira/1600/900'
tags: [ai-agent, jira, testing, claude-code, qa]
---

![AI 에이전트 테스트 결과 Jira 기록](https://picsum.photos/seed/ai-agent-test-results-in-jira/1600/900)
